    ...
    branches: [
      {
        ...
        nodes: [
          ...
          { id: 'omb_l4', name: 'Veleno Letale', description: '+10% ATK', branch: 'Ombra Letale', tier: 4, statBonus: { atk: 10 } },
    ...
    branches: [
      ...
      },
      {
        ...
        nodes: [
          ...
          { id: 'nec_s4', name: 'Trasfusione', description: '+8% HP, +5% DEF', branch: 'Sangue', tier: 4, statBonus: { hp: 8, def: 5 } },
